...
const QString &tilitapahtumat::getRaTilitapahtumat() const
{
    return RaTilitapahtumat;
}

void tilitapahtumat::setRaTilitapahtumat(const QString &newRaTilitapahtumat)
{
    RaTilitapahtumat = newRaTilitapahtumat;
}
