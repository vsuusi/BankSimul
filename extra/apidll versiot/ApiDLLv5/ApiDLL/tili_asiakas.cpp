...
const QString &tili_asiakas::getRaTili_Asiakas() const
{
    return RaTili_Asiakas;
}

void tili_asiakas::setRaTili_Asiakas(const QString &newRaTili_Asiakas)
{
    RaTili_Asiakas = newRaTili_Asiakas;
}
