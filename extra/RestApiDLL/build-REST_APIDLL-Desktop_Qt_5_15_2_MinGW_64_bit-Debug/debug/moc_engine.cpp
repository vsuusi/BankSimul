...
QT_MOC_LITERAL(1, 7, 15), // "sendToMainClass"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "Engine\0sendToMainClass\0"
};
...
void Engine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendToMainClass((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::sendToMainClass)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Engine::sendToMainClass(QString _t1)
{
